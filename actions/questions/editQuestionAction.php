...
if(isset($_POST['validate'])){
    ...
    if(!empty($_POST['title']) AND !empty($_POST['description']) AND !empty($_POST['content']) ){
        ...
        // Modifier les informations de la question qui possède l'id rentré en paramètre //
        $editQuestionOnWebsite = $bdd->prepare('UPDATE questions SET titre = ?, question_description = ?, contenu = ? WHERE id = ?');
